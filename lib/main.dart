...
class BookListScreen extends StatelessWidget {
  final List<Map<String, String>> books = [
    ...
    },
    {
      ...
      'description': 'If you work with data in Python and are looking to create data apps that showcase ML models and make beautiful interactive visualizations, then this is the ideal book for you. '
          'Streamlit for Data Science helps you create apps quickly.'
    },
  ];
...
class ReadingBookFile extends StatefulWidget {
  ...
  ReadingBookFile({required this.index});
...
class _ReadingBookFileState extends State<ReadingBookFile> {
  ...
  String getPdfPath(int index) {
    switch (index) {
      case 0:
        return 'assets/pdf/book1.pdf';
      case 1:
        return 'assets/pdf/book2.pdf';
      case 2:
        return 'assets/pdf/book3.pdf';
      default:
        return 'assets/pdf/book1.pdf';
    }
  }
  ...
  Future<void> loadPdf() async {
    try {
      final path = getPdfPath(widget.index);
